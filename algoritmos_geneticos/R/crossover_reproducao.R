...
individuo2 = new("Individuo", espacos = espacos, valores = valores, limiteEspacos = limite)
individuo2@cromossomo = gerarCromossomo(length(listaProdutos))
individuo2 = avaliacao(individuo2)
print("Indivíduo 2")
for (i in 1:length(listaProdutos)) {
...
cat("Nota: ", individuo2@notaAvaliacao, "\nEspaço usado: ", individuo2@espacoUsado)

filhos = crossover(individuo1, individuo2)
cat("\nIndivíduo 1: ", individuo1@cromossomo, "\nIndivíduo 2: ", individuo2@cromossomo,
    "\nFilho 1: ", filhos[[1]]@cromossomo, "\nFilho 2: ", filhos[[2]]@cromossomo)
